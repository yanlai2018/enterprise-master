...
-- Records of t_about
-- ----------------------------
INSERT INTO `t_about` VALUES ('6', '海南奇迹乍现科技有限公司是一个年轻、活力、富有极强的创造力及社会责任感的年轻团队，置身于最前沿的科技创新领域，服务于各类科技创新产业体系中的客户需求。无论是单位对kpi要求高，要求尽快产出专利交底书，还是作为企业经营者的您想要通过互联网+提升公司的经营运转效率，都可以在本公司找到性价比最高的全流程解决方案，无论您是屡屡碰壁的求职者还是在单位被疯狂女pua后被迫离职的仲裁人员，本单位都能有效的协助您得到满意的结果。本单位奉行成人达己，客户危险的服务理念。对自身的技术深度和解决问题的能力不断的打磨和提炼，争取和客户一起成长。让您或您的单位在这里享受一站式解决方案加成。');
...
-- ----------------------------
INSERT INTO `t_articlecategory` VALUES ('1', '公司动态', '    海南奇迹乍现科技有限公司成立于2022年，位于海南省海口市龙华区国贸路59号正昊大厦
C20-11房。是一家专注于科技创新项目运转，科技创新专利底稿撰写，仲裁知识援助的
智力密集型企业。主要经营范围是：
创新专利：科技发明专利交底书，实用专利交底书，商标；
科技项目：企业名称，企业信息化，办公软件项目，运维项目，科技创新项目；
仲裁援助：协助提供仲裁咨询，全力保障客户的仲裁权益，协助整理仲裁资料；
公司一贯以“业内较低的价格”、提供“最高高品质的产品”、树立社会信誉，立志
发展壮大为一家百年企业。本公司期待成为你忠实的朋友和合作伙伴，
共创互惠双赢的未来！', 'GongSiDongTai', '1');
...
-- ----------------------------
INSERT INTO `t_contact` VALUES ('5', '<span style=\"white-space:normal;\">公司地址：海南省海口市龙华区国贸路59号正昊大厦C20-11房</span> \r\n<p style=\"white-space:normal;\">\r\n	电话：150****9523\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	联系人：王先生\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	仲裁援助\r\n</p>' ||
                                     '<a target="_blank" href="https://qm.qq.com/cgi-bin/qm/qr?k=h5fqN29jD1PUmuxwwWTd1KJ4czuU4GDh&jump_from=webapi&authKey=UwF9AgvGfi0eF7JZhWEUmKmoLyxiNbh/z00I4bBlJa0j+FLxrvZeGjgEFMmPT+ZQ"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="洋流涌动-仲裁" title="洋流涌动-仲裁"></a>' ||
                                     '\r\n<p style=\"white-space:normal;\">\r\n	专利底稿\r\n</p>'' ||
                                     ''<a target="_blank" href="https://qm.qq.com/cgi-bin/qm/qr?k=h5fqN29jD1PUmuxwwWTd1KJ4czuU4GDh&jump_from=webapi&authKey=UwF9AgvGfi0eF7JZhWEUmKmoLyxiNbh/z00I4bBlJa0j+FLxrvZeGjgEFMmPT+ZQ"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="洋流涌动-专利" title="洋流涌动-专利"></a>' ||
                                     '\r\n<p style=\"white-space:normal;\">\r\n	科技项目\r\n</p>'' ||
                                     ''<a target="_blank" href="https://qm.qq.com/cgi-bin/qm/qr?k=h5fqN29jD1PUmuxwwWTd1KJ4czuU4GDh&jump_from=webapi&authKey=UwF9AgvGfi0eF7JZhWEUmKmoLyxiNbh/z00I4bBlJa0j+FLxrvZeGjgEFMmPT+ZQ"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="洋流涌动-项目" title="洋流涌动-项目"></a>\r\n<p style=\"white-space:normal;\">\r\n	邮箱：wangyanlai@yangliuyongdong.com\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<br />\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<br />\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<iframe src=\"http://localhost:8080/resource/kindeditor/plugins/baidumap/index.html?center=110.325625%2C20.030462&zoom=18&width=558&height=360&markers=113.94547%2C22.530027&markerStyles=l%2CA\" frameborder=\"0\" style=\"width:560px;height:362px;\">\r\n	</iframe>\r\n</p>');
...
-- ----------------------------
INSERT INTO `t_service` VALUES ('1', '创新专利', '对接奇迹乍现科技有限公司，无数的亮点子喷涌而出', 'y', '2');
INSERT INTO `t_service` VALUES ('2', '创新项目', '让您的企业经营信息化实现降本增效，各类企业办公平台快速搭建', 'y', '1');
INSERT INTO `t_service` VALUES ('3', '仲裁援助', '不设限的仲裁援助，成本最低的为您实现量身定制的保护，', 'y', '1');
